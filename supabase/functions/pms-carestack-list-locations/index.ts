...
serve(async (req) => {
  ...
  try {
    ...
    // Get office configuration from request params
    ...
    await supabase.from('audit_log').insert({
      ...
      action: 'pms_list_locations',
      entity: 'carestack_locations',
      entity_id: officeId,
      diff_json: { count: locations.length }
    })
    ...
    console.error('Error in pms-carestack-list-locations:', error)
